...
#O programa deve permitir ao usuário três tentativas para acertar o nome de usuário e a 
#senha corretos. Caso o usuário erre as credenciais, o programa deve fornecer uma mensagem 
#informando quantas tentativas restam. Se o usuário acertar, uma mensagem de boas-vindas deve ser exibida, 
#e o programa deve terminar imediatamente. Se todas as três tentativas falharem, o programa deve usar um loop 
#for para exibir uma mensagem de "Acesso bloqueado" repetida três vezes.
